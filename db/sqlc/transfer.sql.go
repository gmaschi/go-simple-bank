...
const listTransfersFromAccountId = `-- name: ListTransfersFromAccountId :one
SELECT id, from_account_id, to_account_id, amount, created_at FROM transfers
...
func (q *Queries) ListTransfersFromAccountId(ctx context.Context, arg ListTransfersFromAccountIdParams) (Transfer, error) {
	row := q.db.QueryRowContext(ctx, listTransfersFromAccountId, arg.FromAccountID, arg.Limit, arg.Offset)
	var i Transfer
	err := row.Scan(
		&i.ID,
		&i.FromAccountID,
...
const listTransfersFromToAccountId = `-- name: ListTransfersFromToAccountId :one
SELECT id, from_account_id, to_account_id, amount, created_at FROM transfers
WHERE (from_account_id = $1, to_account_id = $2)
LIMIT $3 OFFSET $4
`

type ListTransfersFromToAccountIdParams struct {
	FromAccountID int64 `json:"from_account_id"`
	ToAccountID   int64 `json:"to_account_id"`
	Limit         int32 `json:"limit"`
	Offset        int32 `json:"offset"`
...
func (q *Queries) ListTransfersFromToAccountId(ctx context.Context, arg ListTransfersFromToAccountIdParams) (Transfer, error) {
	row := q.db.QueryRowContext(ctx, listTransfersFromToAccountId,
		arg.FromAccountID,
		arg.ToAccountID,
		arg.Limit,
		arg.Offset,
...
const listTransfersToAccountId = `-- name: ListTransfersToAccountId :one
SELECT id, from_account_id, to_account_id, amount, created_at FROM transfers
...
func (q *Queries) ListTransfersToAccountId(ctx context.Context, arg ListTransfersToAccountIdParams) (Transfer, error) {
	row := q.db.QueryRowContext(ctx, listTransfersToAccountId, arg.ToAccountID, arg.Limit, arg.Offset)
	var i Transfer
	err := row.Scan(
		&i.ID,
		&i.FromAccountID,
